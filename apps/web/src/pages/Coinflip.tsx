...
import { Button, Card, CardContent, CardHeader, ErrorState, Input, Select, Skeleton } from '../components/ui'
      ...
      <Card>
        ...
        <CardContent className="space-y-2">
          {is_games_loading ? (
            ...
            <div className="text-sm text-muted-foreground">Nenhuma aposta encontrada.</div>
          )}
        </CardContent>
      </Card>
    </div>
