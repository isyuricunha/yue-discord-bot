      ...
      <div data-theme="yudark" className="flex min-h-screen flex-col bg-canvas">
        <div className="flex min-h-screen flex-col">
          ...
          <header className="flex w-full items-center justify-between px-6 py-5" role="banner">
            <NavLink
              to="/extras"
              className="flex items-center gap-2.5 rounded-xl p-1.5 transition-colors hover:bg-surface-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/35"
            ...
            <nav className="flex items-center gap-2">
              <NavLink
                to="/extras"
                className="inline-flex items-center rounded-xl px-3 py-2 text-sm text-muted-foreground transition-colors hover:bg-surface-hover hover:text-foreground"
              >
                Extras
              </NavLink>
            </nav>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="relative my-5">
                    ...
                    <div className="relative flex justify-center text-xs">
                      <span className="bg-surface px-2 text-muted-foreground/60">ou</span>
                    </div>
                  </div>
                  ...
                  {inviteLink && (
                    <Button
                      ...
                      size="lg"
                      variant="outline"
                      className="w-full border-accent/30 text-foreground transition-colors hover:border-accent/50 hover:bg-accent/10"
