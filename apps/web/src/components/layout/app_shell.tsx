...
export function AppShell() {
  ...
  return (
    <div data-theme="yu-dark" className="h-screen overflow-hidden bg-background text-foreground">
      <Seo />
      ...
      <div className="relative flex h-full">
        ...
        <div className="min-w-0 flex flex-1 flex-col">
          <div className="scrollbar-yue min-h-0 flex-1 overflow-y-auto">
            <Topbar />
            <main id="main-content" className={cn('px-4 py-4 sm:px-5', 'animate-fadeIn')} key={content_key} tabIndex={-1}>
              <Outlet />
            </main>
          </div>
        </div>
